...
class MultilangTest extends PHPUnit_Framework_TestCase {
  ...
  public function testMultilangSupport() {
    ...
    $dir = basename(KIRBY_CMS_ROOT);

    $expected = '<img src="http://superurl.com/' . $dir . '/test/etc/testContent/01-tests/multilang/image-01.jpg" title="Title for an english image-01" />';
    ...
    $expected = '<a href="http://superurl.com/' . $dir . '/test/etc/testContent/01-tests/multilang/image-01.jpg">image-01.jpg</a>';
    $this->assertEquals($expected, (string)$kirbytext);
