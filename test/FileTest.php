...
class FileTest extends PHPUnit_Framework_TestCase {
  ...
  public function testDocument() {
    ...
    $this->assertInstanceOf('KirbyFile', $file);
  ...
  public function testImage() {
    ...
    $this->assertInstanceOf('KirbyContent', $file->meta());
    $this->assertTrue($file->hasMeta());
    $this->assertInstanceOf('KirbyVariable', $file->title());
    ...
    $this->assertInstanceOf('KirbyImage', $image->thumb());
  ...
  public function testContent() {
    ...
    $this->assertInstanceOf('KirbyContent', $file);
