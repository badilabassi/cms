...
- new KirbyPage::parents()
- KirbySite object inherits from KirbyPage and gains a lot of additional methods
- new KirbySite::files(), KirbySite::images(), KirbySite::documents() etc. 
- lazy loading for pretty much anything
